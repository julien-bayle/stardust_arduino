...
const byte LEFT_WHEEL_PWM = 6;          // MOTOR ( timer 0 / output 5 & 6)
const byte LEFT_WHEEL_DIR = 7;          // MOTOR
const byte LEFT_WHEEL_BRAKE = 8;        // MOTOR

const byte RIGHT_WHEEL_DIR = 9;         // MOTOR
const byte RIGHT_WHEEL_BRAKE = 10;      // MOTOR
const byte RIGHT_WHEEL_PWM = 11;        // MOTOR ( timer 1 / output 11 & 12)
